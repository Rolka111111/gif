...
#install ssh-vpn
sleep 1
wget -q -O ssh-vpn.sh https://raw.githubusercontent.com/arismaramar/gif/main/images/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
sleep 1
wget -q -O ssh-vpn2.sh https://raw.githubusercontent.com/arismaramar/gif/main/images/vpn.sh && chmod +x ssh-vpn2.sh && ./ssh-vpn2.sh
sleep 1
#install ins-xray
