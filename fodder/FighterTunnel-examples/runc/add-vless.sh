...
vlesslink2="vless://${uuid}@${sts}${domain}:80?type=ws&encryption=none&security=none&host=${domain}&path=/vless#XRAY_VLESS_NON_TLS_${user}"
...
echo -e "Multipath         : /bebas (XRAY Core Mod Only)"
echo -e "═══════════════════"
