...
installbbrplus(){
		...
		wget -N --no-check-certificate http://raw.githubusercontent.com/chiakge/Linux-NetSpeed/master/bbrplus/debian-ubuntu/x64/linux-headers-4.14.129-bbrplus.deb >/dev/null 2>&1
		wget -N --no-check-certificate http://raw.githubusercontent.com/chiakge/Linux-NetSpeed/master/bbrplus/debian-ubuntu/x64/linux-image-4.14.129-bbrplus.deb >/dev/null 2>&1
