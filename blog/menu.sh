...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/arismaramar/gif/main/blog/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/arismaramar/gif/main/blog/PLUGINS/versi)
...
serverV=$( curl -sS https://raw.githubusercontent.com/arismaramar/gif/main/blog/PLUGINS/versi)
...
echo -e "$COLOR1 $NC ${WH}Client Name ${COLOR1}: ${WH}anggun DM${NC}"
