...
sed -i '$ iproxy_pass http://127.0.0.1:19001;' /etc/nginx/conf.d/xray.conf
...
sed -i '$ i                   proxy_pass http://127.0.0.1:19002;' /etc/nginx/conf.d/xray.conf
...
sed -i '$ i     }' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_redirect off;' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_pass http://127.0.0.1:19003;' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_http_version 1.1;' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_set_header Upgrade $http_upgrade;' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_set_header Connection "upgrade";' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_set_header Host $host;' /etc/nginx/conf.d/xray.conf
...
sed -i '$ i     }' /etc/nginx/conf.d/xray.conf
sed -i '$ i                   proxy_redirect off;' /etc/nginx/conf.d/xray.conf
sed -i '$ i                   proxy_pass http://127.0.0.1:19004;' /etc/nginx/conf.d/xray.conf
sed -i '$ i                   proxy_http_version 1.1;' /etc/nginx/conf.d/xray.conf
sed -i '$ i                   proxy_set_header Upgrade $http_upgrade;' /etc/nginx/conf.d/xray.conf
sed -i '$ i                   proxy_set_header Connection "upgrade";' /etc/nginx/conf.d/xray.conf
sed -i '$ i                   proxy_set_header Host $host;' /etc/nginx/conf.d/xray.conf
...
sed -i '$ i                          grpc_pass grpc://127.0.0.1:19005;' /etc/nginx/conf.d/xray.conf
sed -i '$ i     }' /etc/nginx/conf.d/xray.conf
sed -i '$ i' /etc/nginx/conf.d/xray.conf
sed -i '$ i     # Important:' /etc/nginx/conf.d/xray.conf
...
sed -i '$ igrpc_pass grpc://127.0.0.1:19006;' /etc/nginx/conf.d/xray.conf
sed -i '$ i     }' /etc/nginx/conf.d/xray.conf
sed -i '$ i' /etc/nginx/conf.d/xray.conf
sed -i '$ i     # Important:' /etc/nginx/conf.d/xray.conf
...
sed -i '$ i                          grpc_set_header X-Forwarded-For \$proxy_add_x_forwarded_for;' /etc/nginx/conf.d/xray.conf
sed -i '$ i                          grpc_set_header Host \$http_host;' /etc/nginx/conf.d/xray.conf
sed -i '$ i                          grpc_pass grpc://127.0.0.1:19007;' /etc/nginx/conf.d/xray.conf
sed -i '$ i     }' /etc/nginx/conf.d/xray.conf
sed -i '$ i' /etc/nginx/conf.d/xray.conf
sed -i '$ i     # Important:' /etc/nginx/conf.d/xray.conf
...
sed -i '$ igrpc_set_header X-Forwarded-For \$proxy_add_x_forwarded_for;' /etc/nginx/conf.d/xray.conf
sed -i '$ igrpc_set_header Host \$http_host;' /etc/nginx/conf.d/xray.conf
sed -i '$ igrpc_pass grpc://127.0.0.1:19008;' /etc/nginx/conf.d/xray.conf
sed -i '$ i' /etc/nginx/conf.d/xray.conf
sed -i '$ i      }' /etc/nginx/conf.d/xray.conf
sed -i '$ i      # Important:' /etc/nginx/conf.d/xray.conf
...
wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/arismaramar/gif/main/blog/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
sleep 1
wget -q -O /usr/bin/auto-set "https://raw.githubusercontent.com/arismaramar/gif/main/blog/auto-set.sh" && chmod +x /usr/bin/auto-set 
wget -q -O /usr/bin/crtxray "https://raw.githubusercontent.com/arismaramar/gif/main/blog/crt.sh" && chmod +x /usr/bin/crtxray 
sleep 1
