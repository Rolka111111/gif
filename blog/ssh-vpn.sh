...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/arismaramar/gif/main/blog/nginx.conf"
rm /etc/nginx/conf.d/vps.conf
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/arismaramar/gif/main/blog/vps.conf"
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/arismaramar/gif/main/images/newudpgw"
...
cd
# setting port ssh
wget -q -O /etc/ssh/sshd_config https://raw.githubusercontent.com/arismaramar/gif/main/fodder/FighterTunnel-examples/sshd_config
/etc/init.d/ssh restart

echo "=== Install Dropbear ==="
# install dropbear
#apt -y install dropbear
wget -q -O /etc/default/dropbear https://raw.githubusercontent.com/arismaramar/gif/main/fodder/FighterTunnel-examples/dropbear
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/arismaramar/gif/main/blog/squid3.conf"
...
# download script
cd /usr/bin
wget -O speedtest "https://raw.githubusercontent.com/arismaramar/gif/main/images/speedtes_cli.py"
wget -O xp "https://raw.githubusercontent.com/arismaramar/gif/main/blog/xp.sh"
wget -O auto-set "https://raw.githubusercontent.com/arismaramar/gif/main/blog/auto-set.sh"
chmod +x speedtest
chmod +x xp
chmod +x auto-set
cd
